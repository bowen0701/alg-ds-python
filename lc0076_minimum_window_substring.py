...
class SolutionDictTwoPointers(object):
    def minWindow(self, s, t):
        ...
        # Track min left & right, and counter.
        ...
        while right < s_len:
            # If s[right] exits in t, decrement counter.
            if t_char_counts[s[right]] > 0:
                counter -= 1

            # Decrement t_char_counts[s[right]], which will be < 0,
            # if s[right] does not exist in t.
...
def main():
    ...
    print SolutionDictTwoPointers().minWindow(s, t)
